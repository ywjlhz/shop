                ...
                <div id="goodsInfo" class="clearfix">
                    ...
                    <div class="imgInfo">
                        ...
                        <div class="con-FangDa" id="fangdajing">
                            ...
                            <!-- 正常显示的图片-->
                            <img src="/Public/Upload/goods/<?php echo ($data["goods_big_img"]); ?>">
                            <!-- 滑块-->
                            <div class="magnifyingBegin"></div>
                            <!-- 放大镜显示的图片 -->
                            <div class="magnifyingShow"><img src="/Public/Upload/goods/<?php echo ($data["goods_big_img"]); ?>"></div>
                            </div>
                            <ul class="con-FangDa-ImgList">
                            <!-- 图片显示列表 -->
                                <?php if(is_array($img_datas)): foreach($img_datas as $key=>$d): ?><li style="width: 66.6px; height: 50px;"><img style="width: 66.6px; height: 50px;" src="/Public/Upload/goods/<?php echo ($d["thumb_img"]); ?>" data-bigimg="/Public/Upload/goods/<?php echo ($d["big_img"]); ?>"></li><?php endforeach; endif; ?>
                            </ul>
                            </div>
                    </div>
                    ...
                    <div class="textInfo">
                        <form method="post" name="ECS_FORMBUY" id="cart_form">
                            <input name="goods_id" value="<?php echo ($data["id"]); ?>" type="hidden" />
                            ...
                            <ul>
                                ...
                                <li class="clearfix">
                                    <dd>
                                        <strong>商品重量：</strong><?php echo ($data["goods_weight"]); ?>
                                    </dd>
                                </li>
                                <li class="clearfix">
                                    <dd>
                                        <strong>上架时间：</strong><?php echo (date('Y-m-d H:i:s',$data["created_time"])); ?>
                                    </dd>
                                </li>
                                <li class="clearfix">
                                    <dd>
                            ...
                            <?php if(is_array($attr_datas)): foreach($attr_datas as $key=>$d): ?><li class="padd loop">
                                    <strong><?php echo ($d["attr_name"]); ?>:</strong>
                                    <?php if(is_array($d["goods_attr_value"])): foreach($d["goods_attr_value"] as $key=>$dd): if($d["attr_type"] == 2): ?><input name="attr[<?php echo ($d["attr_name"]); ?>]" id="spec_value_227" type="radio" value="<?php echo ($dd); ?>" checked/>
                                            <?php echo ($dd); ?>
                                            <?php else: ?>
                                            <?php echo ($dd); ?>:<input type="text" name="attr[<?php echo ($d["attr_name"]); ?>]"><?php endif; endforeach; endif; ?>
                                ...
                                <li class="padd">
                                    ...
                                    <a href="javascript:void(0)" id="collect"><img src="/Public/Home/images/shoucang2.gif"></a>
                        ...
                        <script>
                            $('#collect').click(function () {
                                ...
                                formObj.attr('action','<?php echo U("cart/add");?>')
                                formObj.submit();
                            })
                        </script>
                    </div>
