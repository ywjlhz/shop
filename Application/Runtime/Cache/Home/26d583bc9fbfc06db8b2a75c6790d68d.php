    ...
    .error{
        ...
        <div class="block block1">  
            ...
            <div class="block box">
                <div class="blank"></div>
                <div id="ur_here">
                    当前位置: <a href="<?php echo U('index/index');?>">首页</a> <code>&gt;</code> 用户注册
                </div>
            </div>
            <div class="blank"></div>
                            ...
                            <table cellpadding="5" cellspacing="3" style="text-align:left; width:100%; border:0;">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td align="right"><label for="qq">qq号码</label></td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                        <input class="inputBg" size="25" name="captcha" id="captcha" type="text" value="" /><img src='<?php echo U("login/captcha");?>' onclick="this.src='/index.php/Home/Login/captcha/t='+Math.random()" alt="看不清换一张" />
