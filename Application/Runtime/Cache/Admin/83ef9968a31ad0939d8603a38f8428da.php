        ...
        <div style="font-size: 13px;margin: 10px 5px">
            ...
            <table border="1" width="100%" class="table_a">
                ...
                <tr>
                 ...
                 <tr>
                    <td>属性值的类型</td>
                    <td><input type="radio" value="1" name="attr_type" />输入框<input type="radio" value="2" name="attr_type" />下拉框</td>
                </tr>
                 <tr>
                    <td>属性值录入方式</td>
                    <td><input type="radio" value="1" name="attr_insert_type" />手工录入<input type="radio" value="2" name="attr_insert_type" />列表选择</td>
                </tr>
                 <tr>
                    <td>可选值列表</td>
